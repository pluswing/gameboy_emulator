...
pub fn from_byte_prefixed(byte: u8) -> Option<Instruction> {
    match byte {
        ...
        0x28 => Some(Instruction::SRA(SRA_Arg_0::B, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
        0x29 => Some(Instruction::SRA(SRA_Arg_0::C, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
        0x2A => Some(Instruction::SRA(SRA_Arg_0::D, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
        0x2B => Some(Instruction::SRA(SRA_Arg_0::E, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
        0x2C => Some(Instruction::SRA(SRA_Arg_0::H, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
        0x2D => Some(Instruction::SRA(SRA_Arg_0::L, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
        0x2E => Some(Instruction::SRA(SRA_Arg_0::Indirect_HL, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
        0x2F => Some(Instruction::SRA(SRA_Arg_0::A, Flags { zero: FlagValue::CHANGE, subtract: FlagValue::FORCE_FALSE, half_carry: FlagValue::FORCE_FALSE, carry: FlagValue::FORCE_FALSE })),
